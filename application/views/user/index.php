...
<!-- Dashboard analytics area start -->
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        ...
                        <h2><span class="counter">20</span> <span class="tuition-fees">Users</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Documents</h5>
                        <h2><span class="counter">30</span> <span class="tuition-fees">Pages</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Signed</h5>
                        <h2><span class="counter">60</span> <span class="tuition-fees">Signin</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Sent Docs</h5>
                        <h2><span class="counter">35</span> <span class="tuition-fees">Send</span></h2>
                        <span class="text-inverse">35%</span>
                        <div class="progress m-b-0">
                            <div class="progress-bar progress-bar-inverse" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:35%;"> <span class="sr-only">35% Complete</span> </div>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Dashboard analytics area End -->

<!-- Dashboard list Docs start -->
                    ...
                    <div class="asset-inner">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="pd-setting btn-block">Signed</button>
                                </td>
                                <td>Dec 3, 2021</td>
                                <td>
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                <button type="button" class="btn btn-custon-four btn-default dropdown-toggle1" data-toggle="dropdown">View <i class="fa fa-angle-down"></i>
                                                </button>
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 33%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <td>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                <button type="button" class="btn btn-custon-four btn-default dropdown-toggle1" data-toggle="dropdown">Options <i class="fa fa-angle-down"></i>
                                                </button>
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 33%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
                                                    <li>
                                                        <a href="#">Edit & Resend</a>
                                                        <hr>
                                                    </li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="#">Generated signing link</a>
                                                        <hr>
                                                    </li>
                                                    <li>
                                                        <a href="#">Delete</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="ps-setting btn-block">Awaiting</button>
                                </td>
                                <td>Dec 3, 2021</td>
                                <td>
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 43%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 43%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="ds-setting btn-block">Draft</button>
                                </td>
                                <td>Dec 3, 2021</td>
                                <td>
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 53%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 53%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 63%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 63%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 73%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 73%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 83%; left:67%; " role="menu">
                                                    <li><a href="#"><?= $user['name']; ?> - <?= $user['email']; ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="button-ap-list responsive-btn">
                                        <div class="button-style-four">
                                            <div class="button-drop-style-one btn-default-bg">
                                                ...
                                                <ul class="dropdown-menu btn-dropdown-menu another-drop-pro-two dropdown-toggle1 sp-btn-dp-1" style="top: 83%; left:80.5%; " role="menu">
                                                    <li>
                                                        <a href="#">Preview</a>
                                                        <hr>
                                                    </li>
...
<!-- Dashboard traffic-analysis area start -->
...
<!-- Dashboard traffic-analysis area end -->

<!-- Dashboard library-book area start -->
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="single-cards-item">
                    <div class="single-product-image">
                        <a href="#"><img src="<?= base_url(); ?>assets/img/product/profile-bg.jpg" alt=""></a>
                    </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                <div class="single-review-st-item res-mg-t-30 table-mg-t-pro-n">
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/1.jpg" alt="">
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/2.jpg" alt="">
                        <div class="review-ctn-hf">
                            <h3>Garbease sha</h3>
                            <p>Awesome Pro</p>
                        </div>
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/3.jpg" alt="">
                        <div class="review-ctn-hf">
                            <h3>Gobetro pro</h3>
                            <p>Great Website</p>
                        </div>
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/4.jpg" alt="">
                        <div class="review-ctn-hf">
                            <h3>Siam Graves</h3>
                            <p>That's Good</p>
                        </div>
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/5.jpg" alt="">
                        <div class="review-ctn-hf">
                            <h3>Sarah Graves</h3>
                            <p>Highly recommend</p>
                        </div>
                    ...
                    <div class="single-review-st-text">
                        <img src="<?= base_url(); ?>assets/img/notification/6.jpg" alt="">
                        <div class="review-ctn-hf">
                            <h3>Julsha Grav</h3>
                            <p>Sei Hoise bro</p>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="single-product-item res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                    <div class="single-product-image">
                        <a href="#"><img src="<?= base_url(); ?>assets/img/product/book-4.jpg" alt=""></a>
                    </div>
...
<!-- Dashboard library-book area end -->

<!-- Dashboard product-sales area start -->
<!--<div class="product-sales-area mg-tb-30">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <div class="courses-inner res-mg-t-30 table-mg-t-pro-n tb-sm-res-d-n dk-res-t-d-n">
                    <div class="courses-title">
                        <a href="#"><img src="<?= base_url(); ?>assets/img/courses/1.jpg" alt="" /></a>
