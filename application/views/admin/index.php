        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Users</h5>
                        <h2><span class="counter">5000</span> <span class="tuition-fees">Users</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30">
                    <div class="analytics-content">
                        <h5>Documents</h5>
                        <h2><span class="counter">3000</span> <span class="tuition-fees">Pages</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Signed</h5>
                        <h2><span class="counter">2000</span> <span class="tuition-fees">Signin</span></h2>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <h5>Sent Docs</h5>
                        <h2><span class="counter">3500</span> <span class="tuition-fees">Send</span></h2>
                        <span class="text-inverse">80%</span>
                        <div class="progress m-b-0">
                            <div class="progress-bar progress-bar-inverse" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:80%;"> <span class="sr-only">30% Complete</span> </div>
                        </div>
                    </div>
                </div>
            </div>
